...
#Preview {
    ColumnDetail(column: Column(title: "연습용 제목", content: "Example content", userNickname: "북극성", font: "", backgroundImageName: "", categories: ["에세이"], likes: [], comments: ["댓글 1", "댓글 2", "댓글 3"], date: Date()))
